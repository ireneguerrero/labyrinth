		...
		case 1:
			...
			try {
				...
				this.celdas = new Celda[][] {
						...
						{ new Muro(), new Celda(), new CeldaVacia(new Puerta(l, material)), new Celda(), new Muro() },
						{ new Muro(), new Muro(), new Muro(), new Celda(), new Muro() },
		...
		case 2:
			...
			try {
				...
				this.celdas = new Celda[][] {
						...
						{ new Muro(), new Muro(), new Muro(), new Celda(), new Muro() },
						{ new Muro(), new Muro(), new Muro(), new CeldaVacia(new Puerta(l, material)), new Muro() },
						{ new Muro(), new Muro(), new Muro(), new Celda(), new Muro() },
		...
		case 3:
			...
			try {
				...
				this.celdas = new Celda[][] {
						...
						{ new Celda(), new Celda(), new CeldaVacia(new Puerta(l, material)), new Celda(), new Muro() },
						{ new Muro(), new Muro(), new Muro(), new Celda(), new Muro() },
		...
		case 4:
			...
			try {
				...
				this.celdas = new Celda[][] {
						...
						{ new Muro(), new Muro(), new CeldaVacia(new Puerta(l, material)), new Muro(), new Muro() },
